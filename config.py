...
class Config(object):
    ...
    SQLALCHEMY_DATABASE_URI = 'mysql+pymysql://root:root@172.20.10.3:3306/test?charset=utf8'
...
class ProductionConfig(Config):
    ...
    DEBUG = False
    SQLALCHEMY_DATABASE_URI = 'mysql+pymysql://root:mysql@47.106.93.190:3306/test'
